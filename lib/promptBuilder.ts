...
export const buildStructuredPrompt = ({ values, promptDelta, reduceClutter }: PromptBuilderInput): string => {
  ...
  return [
    ...
    `Company name to overlay: ${values.companyName}.`,
    `Company description to overlay: ${values.companyDescription}.`,
    `Company name font style: ${values.companyNameFontStyle}.`,
    `Company description font style: ${values.companyDescriptionFontStyle}.`,
    ...
    `Phone number to overlay at right-bottom: ${values.phoneNumber}.`,
